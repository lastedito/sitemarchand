...
<body>
	...
	<a class="js" href="#" onclick="setActiveStyleSheet('error404'); return false;">Style par défaut</a>
	...
	<section id="slideshow">
		...
		<span id="timeline"></span>
            ...
            <section>
                ...
                <aside>
				<h2>CECI EST UNE PAGE DE REDIRECTION AUTOMATIQUE EN CAS D'ERREUR 404.</h2><br />
				<p>L'ERREUR 404 est dût à une absence de page (non existante),<br/>
				qui dans le cas du site est soit une mauvaise manipulation du code donc un "faux lien" ou "lien mort"<br/>
                                (Si tel est le cas, veuillez-nous en informer s.v.p !!)<br/>
				OU alors une page encore non-créer (par exemple un projet(nouvelles news, etc...)).<br/><br/>
				Je vous invite donc à retourner sur la page précédente ou bien nous contacter pour obtenir plus d'information.<br/>
                                Vous pouvez aussi retourner sur la page d'accueil en cliquant <a href="index.php">ici</a>.<br/><br/>
				-<a href="mailto:admin@forumava-ltd.shost.ca">Modérateur du site.</a>-</p>
				</aside>
            </section>
