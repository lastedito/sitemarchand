...
<body>
	...
	<a class="js" href="#" onclick="setActiveStyleSheet('archives'); return false;">Style par défaut</a>
	...
	<section id="slideshow">
		...
		<span id="timeline"></span>
            ...
            <section>
                <article>
				<h1>&nbsp;&nbsp;Archives</h1>
				<h4>&nbsp;&nbsp;Vous pouvez retrouver toutes les pages d'actualités ici.</h4>
				<p class="p1"><a href=news 1.php>News1</a></p>
                </article>
                <aside>
				<h3>________________________</h3>	</br>
