...
function obtenirDetailVisiteur($idCnx, $unId) {
    ...
    $requete = "select idclient, nomcli, prenomcli from client where idclient='" . $unId . "'";
...
function verifierInfosConnexion($idCnx, $unLogin, $unMdp) {
    ...
    $req = "select idclient, nomcli, prenomcli, login, mdp from client where login='".$unLogin."' and mdp='" . $unMdp . "'";
